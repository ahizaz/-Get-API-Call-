...
Procucts procuctsFromJson(String str) => Procucts.fromJson(json.decode(str));
String procuctsToJson(Procucts data) => json.encode(data.toJson());
class Procucts {
  Procucts({
      bool? success, 
      String? message, 
  ...
  Procucts.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
Procucts copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => Procucts(  success: success ?? _success,
